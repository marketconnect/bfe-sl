...
export BFE_PRESIGN_TTL_FOR_ARCHIVE_SECONDS
...
REQUIRED_ENV := PDF_TO_IMAGES_FUNC_NAME BFE_YDB_ENDPOINT BFE_YDB_DATABASE_PATH BFE_JWT_SECRET_KEY BFE_S3_BUCKET_NAME BFE_S3_ACCESS_KEY_ID BFE_S3_SECRET_ACCESS_KEY BFE_ADMIN_USER BFE_ADMIN_PASSWORD BFE_ORIGIN_URL BFE_PRESIGN_TTL_SECONDS BFE_PRESIGN_TTL_FOR_ARCHIVE_SECONDS BFE_SES_ENDPOINT BFE_SES_REGION BFE_SES_ACCESS_KEY_ID BFE_SES_SECRET_ACCESS_KEY BFE_EMAIL_FROM BFE_APP_LOGIN_URL
